...
export type HealthCheckStatusResolvers<ContextType = ContextValue, ParentType extends ResolversParentTypes['HealthCheckStatus'] = ResolversParentTypes['HealthCheckStatus']> = ResolversObject<{
...
export type QueryResolvers<ContextType = ContextValue, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  healthCheck?: Resolver<ResolversTypes['HealthCheckStatus'], ParentType, ContextType>;
}>;
