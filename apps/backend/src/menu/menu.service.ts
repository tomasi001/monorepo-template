import { PrismaClient, Menu, MenuItem } from "@packages/database";
import { MenuRepository, MenuWithItems } from "./menu.repository.js";
import {
  NotFoundError,
  InternalServerError,
  BadRequestError,
...
import { CreateMenuInput } from "../generated/graphql-types.js";
...
export class MenuService {
  ...
  async getMenuById(id: string): Promise<MenuWithItems> {
  ...
  async getMenuItemById(id: string): Promise<MenuItem | null> {
    console.warn(`Placeholder: Fetching menu item ${id}`);
